...
class _CreateRouteScreenState extends State<CreateRouteScreen> {
  ...
  void removeStop(int index) {
    setState(() {
      ...
      stops = List.from(stops)..removeAt(index);
    });
  }
                      ...
                      children: [
                        Expanded(
                          child: TextField(
                            ...
                            readOnly: true,
                            decoration: InputDecoration(
                              labelText: '${l10n.text('addStop')} ${i + 1}',
                              border: const OutlineInputBorder(),
                            ),
                          ),
                        ),
                          ...
                          children: [
                            Expanded(
                              child: TextField(
                                ...
                                autofocus: true,
                                decoration: InputDecoration(
                                  labelText: l10n.text('enterStopLocation'),
                                  border: const OutlineInputBorder(),
                                ),
                              ),
                            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              l10n.text('includeReturnJourney'),
                              style: const TextStyle(
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          onChanged: (v) => setState(
                            () =>
                                pricePerSeat = int.tryParse(v) ?? pricePerSeat,
                          ),
                          controller: TextEditingController(
                            text: '$pricePerSeat',
                          ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Expanded(
                          child: Text(
                            l10n.text('potentialEarningsPerTrip'),
                            style: TextStyle(
                              color: Colors.black54,
